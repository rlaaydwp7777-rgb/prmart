...
import { Download, Eye, Heart, Lock, Send, ShoppingCart, Star, Zap, Clock, User, LogIn, MessageCircle, AlertTriangle } from "lucide-react";
    ...
    if (!isApproved) {
        return (
            <Alert variant="destructive">
                ...
                <AlertTitle>판매 중단된 상품</AlertTitle>
                <AlertDescription>
                    이 상품은 현재 판매 중이 아니거나 관리자 승인 대기 중입니다.
                </AlertDescription>
            </Alert>
        )
    }
