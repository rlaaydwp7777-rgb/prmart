    ...
    <div className="flex min-h-screen w-full flex-col">
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">정산 보류 금액</CardTitle>
              <Activity className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">₩5,730,000</div>
              <p className="text-xs text-muted-foreground">
                +201 since last hour
              </p>
            </CardContent>
        ...
        <div className="grid gap-4 md:gap-8 lg:grid-cols-2 xl:grid-cols-3">
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      <div className="font-medium">Next.js 템플릿</div>
                    </TableCell>
                    <TableCell>
          ...
          <Card>
            <CardHeader>
              <CardTitle>베스트 셀러</CardTitle>
            </CardHeader>
            <CardContent className="grid gap-8">
              <div className="flex items-center gap-4">
                <Avatar className="hidden h-9 w-9 sm:flex">
                  <AvatarImage src="https://picsum.photos/100/100?random=1" alt="Avatar" />
