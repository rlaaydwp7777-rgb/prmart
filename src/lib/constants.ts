...
export const CATEGORIES: Category[] = [
  { 
    ...
    icon: Rocket,
    subCategories: [
      { name: "이미지 프롬프트 (Midjourney, Stable Diffusion)", slug: "image-prompt" },
      { name: "영상 프롬프트 (Sora, Pika Labs 등)", slug: "video-prompt" },
      { name: "텍스트·문서 작성 (ChatGPT 보고서, 블로그 글)", slug: "text-generation" },
      { name: "AI 업무 자동화 (API 활용, RPA 연계)", slug: "ai-automation" },
      { name: "AI 툴 리뷰 & 비교", slug: "ai-tool-review" },
    ]
  },
  { 
    ...
    icon: Code,
    subCategories: [
      { name: "웹/앱 개발 (Next.js, Python, Flutter)", slug: "web-app-dev" },
      { name: "데이터 분석 & 시각화 (SQL, Pandas, Tableau)", slug: "data-analysis" },
      { name: "업무 자동화 (엑셀 VBA, 파이썬 스크립트)", slug: "work-automation" },
      { name: "클라우드/인프라 (AWS, Docker)", slug: "cloud-infra" },
      { name: "보안/해킹 지식", slug: "security-hacking" },
    ]
  },
  { 
    ...
    icon: LineChart,
    subCategories: [
        { name: "주식/ETF 리포트", slug: "stock-etf-report" },
        { name: "부동산 임장/투자 전략", slug: "real-estate-strategy" },
        { name: "코인/블록체인 분석", slug: "crypto-blockchain" },
        { name: "절세·짠테크", slug: "tax-saving" },
        { name: "금융 트렌드 리포트", slug: "financial-trends" },
    ]
  },
  { 
    ...
    icon: Plane,
    subCategories: [
        { name: "국내여행 코스", slug: "domestic-travel" },
        { name: "해외여행 플랜", slug: "overseas-travel" },
        { name: "항공·숙박 꿀팁", slug: "flight-accomm-tips" },
        { name: "여행 사진/영상 노하우", slug: "travel-photography" },
        { name: "소규모 여행 커뮤니티", slug: "small-travel-community" },
    ]
  },
  { 
    name: CATEGORY_NAMES.LIVING_PARENTING_TIPS, 
    slug: "living-parenting",
    icon: Users,
    subCategories: [
        { name: "육아 노하우 (잠재우기, 교육법)", slug: "parenting-knowhow" },
        { name: "생활 절약법", slug: "frugal-living" },
        { name: "건강/헬스 정보", slug: "health-fitness" },
        { name: "집안일 자동화 꿀팁", slug: "home-automation-tips" },
        { name: "음식/레시피 공유", slug: "food-recipes" },
    ]
  },
  { 
    ...
    icon: Briefcase,
    subCategories: [
        { name: "SNS 마케팅 (인스타, 틱톡 운영법)", slug: "sns-marketing" },
        { name: "브랜딩 & 디자인 (로고, 상세페이지)", slug: "branding-design" },
        { name: "세일즈/영업 전략", slug: "sales-strategy" },
        { name: "템플릿·문서 양식 (PPT, 계약서)", slug: "document-templates" },
        { name: "스타트업/창업 노하우", slug: "startup-knowhow" },
    ]
  },
  { 
    ...
    icon: Brush,
    subCategories: [
        { name: "일러스트·캐릭터 리소스", slug: "illustration-character" },
        { name: "UX/UI 디자인 팁", slug: "ux-ui-tips" },
        { name: "사진 보정/촬영 기법", slug: "photo-editing-techniques" },
        { name: "영상 편집 프리셋", slug: "video-editing-presets" },
        { name: "폰트·컬러 팔레트 공유", slug: "font-color-palettes" },
    ]
  },
  { 
    name: CATEGORY_NAMES.LEARNING_SELF_DEVELOPMENT, 
    slug: "learning-self-dev",
    icon: BookOpen,
    subCategories: [
        { name: "외국어 학습법 (영어, 일본어 등)", slug: "language-learning" },
        { name: "자격증 대비 (IT 자격증, 회계 등)", slug: "certification-prep" },
        { name: "글쓰기/스피치", slug: "writing-speech" },
        { name: "뇌과학·학습법", slug: "neuroscience-learning" },
        { name: "온라인 강의 추천", slug: "online-course-recommendations" },
    ]
  },
  { 
    ...
    icon: Car,
    subCategories: [
        { name: "차량 구매 가이드 (국산, 수입)", slug: "car-buying-guide" },
        { name: "중고차 체크리스트", slug: "used-car-checklist" },
        { name: "전기차/신기술 트렌드", slug: "ev-new-tech-trends" },
        { name: "자동차 관리/정비", slug: "car-maintenance" },
        { name: "튜닝·액세서리", slug: "tuning-accessories" },
    ]
  },
  { 
    ...
    icon: Home,
    subCategories: [
        { name: "아파트 시세/임장 리포트", slug: "apartment-market-report" },
        { name: "전월세 계약 꿀팁", slug: "lease-contract-tips" },
        { name: "인테리어 노하우", slug: "interior-knowhow" },
        { name: "지역별 생활 정보", slug: "local-living-info" },
        { name: "부동산 정책 해설", slug: "real-estate-policy" },
    ]
  },
];
