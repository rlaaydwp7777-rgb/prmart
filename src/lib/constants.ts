...
export const CATEGORIES: Category[] = [
  { 
    ...
    icon: Rocket,
    subCategories: [
      { name: "이미지 프롬프트 (Midjourney, Stable Diffusion)" },
      { name: "영상 프롬프트 (Sora, Pika Labs 등)" },
      { name: "텍스트·문서 작성 (ChatGPT 보고서, 블로그 글)" },
      { name: "AI 업무 자동화 (API 활용, RPA 연계)" },
      { name: "AI 툴 리뷰 & 비교" },
    ]
  },
  { 
    ...
    icon: Code,
    subCategories: [
      { name: "웹/앱 개발 (Next.js, Python, Flutter)" },
      { name: "데이터 분석 & 시각화 (SQL, Pandas, Tableau)" },
      { name: "업무 자동화 (엑셀 VBA, 파이썬 스크립트)" },
      { name: "클라우드/인프라 (AWS, Docker)" },
      { name: "보안/해킹 지식" },
    ]
  },
  { 
  ...
  { 
    ...
    icon: Briefcase,
    subCategories: [
        { name: "SNS 마케팅 (인스타, 틱톡 운영법)" },
        { name: "브랜딩 & 디자인 (로고, 상세페이지)" },
        { name: "세일즈/영업 전략" },
        { name: "템플릿·문서 양식 (PPT, 계약서)" },
        { name: "스타트업/창업 노하우" },
    ]
  },
  { 
  ...
  { 
    ...
    icon: BookOpen,
    subCategories: [
        { name: "외국어 학습법 (영어, 일본어 등)" },
        { name: "자격증 대비 (IT 자격증, 회계 등)" },
        { name: "글쓰기/스피치" },
        { name: "뇌과학·학습법" },
        { name: "온라인 강의 추천" },
    ]
