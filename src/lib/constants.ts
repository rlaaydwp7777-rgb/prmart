...
export const FEATURED_PROMPTS: Prompt[] = [
  {
    ...
    description: "A boilerplate for Next.js 14 with TypeScript, Tailwind CSS, and more.",
    author: "DevMaster",
  ...
  },
  {
    ...
    description: "A minimalist UI kit for Figma and Sketch.",
    author: "PixelPerfect",
  ...
  },
  {
    ...
    description: "Proven email sequences to convert your subscribers into customers.",
    author: "GrowthHacker",
  ...
  return { ...p, categorySlug: category?.slug || slugify(p.category) };
});
